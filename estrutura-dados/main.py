...
if menu == 1:
    ...
    # print(lista_teste.recuperar_elemento_no(1))
elif menu == 3:
    ...
    conjunto_teste.inserir(3)
    # conjunto_teste.inserir_posicao(2, 5)
    # conjunto_teste.inserir_posicao(4, 0)
    print(conjunto_teste)
    print(conjunto_teste.remover_elemento(0))
    print(conjunto_teste)
elif menu == 7:
